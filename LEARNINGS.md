...
- Keep harvest feedback renderer-only: a single 760ms wind-up, swing, impact, and stump reveal can play above the already-resolved terrain without changing saves, replays, or action cost. Reduced-motion mode still needs a visible static impact tableau; never hide all confirmation feedback.
