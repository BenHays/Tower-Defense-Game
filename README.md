...
A dependency-free, top-down homestead-defense MVP. Use untimed day actions to clear forest and build outward from the teepee; at night towers fire automatically while Scout serves as the mobile final line at the hearth.
...
1. Every **untimed day** starts with two day actions. On Level 1, clear one tree: it spends both actions, grants **1 wood**, and creates a dedicated build site.
...
3. Level 1 unlocks the **Stick Launcher**. On Level 2, build it for 1 wood and the full day on a cleared forest cell. It deals 1 damage, fires once every 2 seconds, and has short reach.
